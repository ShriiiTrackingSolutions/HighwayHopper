...
<div class="col-auto topheadLinks">
    <a target="_blank" href="tel:+919537528239"><i class="fa-solid fa-phone" aria-hidden="true"></i>+91 95375 28239</a>
    <a target="_blank" href="mailto:highwayhoppers.bookings@gmail.com"><i class="fa-solid fa-envelope" aria-hidden="true"></i> highwayhoppers.bookings@gmail.com</a>
  </div>
  <div class="col-auto topheadSocial">
    ...
    <a target="_blank" href="https://www.instagram.com/high_way.hoppers/"><i class="fa-brands fa-square-instagram" aria-hidden="true"></i></a>
            ...
            <nav class="mynavbar bg-light">
              <div class="container header">
                <a class="brandLogo" href="index.html">
                  <img src="image/TaxiLogo.webp" alt="Highway Hoppers">
                </a>
          ...
          <div class="row">
            ...
            <div class="col-lg-auto col-sm-6 mb-4 mb-md-0 FooterAbout">
              <a class="footer-brand" href="index.html">
                <img loading="lazy" src="image/TaxiLogo.webp" alt="Highway Hoppers">
              </a>
              <p>
...
Rajaram society mujmahuda,
Vadodara 390020</pre>
                  </a>
                </li>
                <li>
                  <a href="tel:+919537528239" class="footerLinks">
                    <i class="fa-solid fa-phone"></i>+91 95375 28239</a>
                </li>
                <li>
                  <a class="emailAnchor footerLinks" href="mailto:highwayhoppers.bookings@gmail.com">
    ...
    <div class="fab-container">
      <a class="set-url-target" rel="noopener" data-mobile-target="" data-desktop-target="_blank" target="_blank" href="https://api.whatsapp.com/send?phone=919537528239">
    ...
    <div class="Call-fab-container">
      <a rel="noopener" target="_blank" href="tel:+919537528239">
...
(function () {
  const mobileLink = "https://api.whatsapp.com/send?phone=919537528239";
  const desktopLink = "https://web.whatsapp.com/send?phone=919537528239";
